...
PYTHON 𒆜 {PYTHON_VERSION}

PTB 𒆜 {PTB_VERSION}
TELETHON 𒆜 {TELETHON_VERSION}
PYROGRAM 𒆜 {PYROGRAM_VERSION}
"""
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="𝘼𝘽𝙊𝙐𝙏", callback_data="Miko_support"
                        ),
                        InlineKeyboardButton(text="𝘾𝙊𝙈𝙈𝘼𝙉𝘿", callback_data="help_back"),
                    ],
                    [
                        InlineKeyboardButton(text="𝙄𝙉𝙎𝙄𝘿𝙀𝙍", callback_data="insider_"),
                    ],
                    [
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="𝙎𝙐𝙋𝙋𝙊𝙍𝙏", url=f"https://t.me/{SUPPORT_CHAT}"
                        ),
                        InlineKeyboardButton(
                            text="𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍", url=f"tg://user?id={OWNER_ID}"
                        ),
                    ],
                    [
