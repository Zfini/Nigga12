...
if ENV:
    ...
    API_ID = int(os.environ.get("27276412", None))
    API_HASH = os.environ.get("861593b9527c2b54d673c0dee3d8f39a", None)
    ...
    SUPPORT_ID = int(os.environ.get("-1002116643591", "-100"))  # Support group id
    SUPPORT_CHAT = os.environ.get("-1001997798206", "zenitsu_bot_support")
    TEMP_DOWNLOAD_DIRECTORY = os.environ.get("TEMP_DOWNLOAD_DIRECTORY", "./")
    TOKEN = os.environ.get("TOKEN", None)

    # Read and validate integer variables
    try:
        OWNER_ID = int(os.environ.get("6305653111", None))
    except ValueError:
...
# <================================================ BOOT MESSAGE=======================================================>
ALIVE_MSG = """
⚡ *𝚂𝚈𝚂𝚃𝙴𝙼 𝙸𝚂 𝚂𝚃𝙰𝚁𝚃𝙴𝙳, 𝙸𝙵 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂 𝙳𝙾𝙽'𝚃 𝚆𝙾𝚁𝙺 𝚃𝙷𝙴𝙽 𝙲𝙷𝙴𝙲𝙺 𝚃𝙷𝙴 𝙻𝙾𝙶𝚂!*


"""

ALIVE_IMG = [
    "https://telegra.ph/file/239da05028e9d12550f60.jpg", 
    "https://telegra.ph/file/8596f73b8af33ab52e96a.jpg", 
    "https://telegra.ph/file/a824d2eeca94669c55e25.jpg"
